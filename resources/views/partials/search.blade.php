			...
			<div class="col-12">
				<div class="search-wrapper">
					<div class="input-group search-container">
						<input type="text" id="search-input" class="form-control search-input" name="str" placeholder="Search Products" aria-label="Search Products" aria-describedby="button-addon2">
